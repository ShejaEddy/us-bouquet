            ...
            <div class="bg-white rounded overflow-hidden">
                <div class="px-4 pt-0 pb-4">
                    <div class="media align-items-end profile-header">
                        ...
                        <div class="media-body mb-5 text-black">
                            <h4 class="mt-0 mb-0">{{$store.getters.auth.user.firstName || 'Tsapal'}}
                                {{$store.getters.auth.user.lastName || 'Rwanda'}}</h4>
                            <p class="small mb-4">{{$store.getters.auth.user.email || 'Tsapal2020@gmail.com'}}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="py-4 px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h5 class="mb-0">Recent Loves</h5><a href="#" class="btn btn-link text-muted">Show all</a>
                    </div>
                    <div class="row">

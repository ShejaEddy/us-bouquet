            ...
            <div class="px-4 pt-0 pb-4">
                <div class="media align-items-end profile-header">
                    ...
                    <div class="media-body mb-5 text-black">
                        <h4 class="mt-0 mb-0">{{$store.getters.auth.user.firstName || 'Sheja'}} {{$store.getters.auth.user.lastName || 'Eddy'}}</h4>
                        <p class="small mb-4">{{$store.getters.auth.user.email || 'shejaeddy@gmail.com'}}</p>
                    </div>
                </div>
            </div>

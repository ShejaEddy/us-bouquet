<template>
	<form id="productCU">
          ...
          <div class="form-group">
            <label for="address-1">Address 1<span class="text-danger">*</span></label>
            <input
              type="text"
              class="form-control"
              id="address-1"
          ...
          <div class="form-group">
            <label for="phone-1">Phone Number 1<span class="text-danger">*</span></label>
            <input
              type="text"
              class="form-control"
              id="phone-1"
          ...
          <div class="form-group">
            <label for="phone-2">Phone Number 2</label>
            <input
              type="text"
              class="form-control"
              id="phone-2"

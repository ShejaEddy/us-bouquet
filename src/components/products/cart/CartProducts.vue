                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-1">
                                                ...
                                                <ul class="list-inline small">
                                                    ...
                                                    <li class="list-inline-item m-0"><i
                                                            class="fa fa-star text-success"></i></li>
                                                    <li class="list-inline-item m-0"><i
                                                            class="fa fa-star text-gray"></i></li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <td class="border-0 align-middle" style="min-width: 150px;">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" @click="removeFromCart(item)"><i
                                                        class="fas fa-minus" style="font-size:0.8em"></i></span>
                                            </div>
                                            <input type="text" class="form-control" style="max-width: 50px;"
                                                   :value="QtyProduct(item)"
                                                   aria-label="Amount (to the nearest dollar)">
                                            <div class="input-group-append">
                                                <span class="input-group-text" @click="addToCart(item)"><i
                                                        class="fas fa-plus" style="font-size:0.8em"></i></span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="border-0 align-middle" style="min-width: 150px;">

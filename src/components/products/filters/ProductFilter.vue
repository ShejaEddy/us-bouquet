  ...
  <div class="productFilter">
    <div id="prdfilter">
      <ul class="list-group cat">
        ...
        <li class="list-group-item" v-for="val in categories" :value="val" @click="(event) => updateFilter(event, val)">{{ val }}</li>
      </ul>
      <ul class="list-group cat">
        <li class="list-group-item cat-title">Shop By Price</li>
        <li class="list-group-item" v-for="val in price" :value="val"  @click="(event) => updateFilter(event, val)">{{ val }}</li>
      </ul>
      <ul class="list-group cat">

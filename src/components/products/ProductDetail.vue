          ...
          <div class="wrapper row">
            <div class="preview col-md-6">
              ...
              <ul class="preview-thumbnail nav nav-tabs">
                <li class="active"><a data-target="#pic-1" data-toggle="tab"><img :src="product.productImage" /></a></li>
            ...
            <div class="details col-md-6">
              ...
              <h4 class="price">current price: <span>{{product.productPrice}}</span></h4>
              ...
              <div class="action">
                <button class="add-to-cart btn btn-primary mr-1" type="button">add to cart <i class="fas fa-cart-plus"></i></button>

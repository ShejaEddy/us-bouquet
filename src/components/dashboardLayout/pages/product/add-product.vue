                ...
                <div class="col-lg-6">
                    <div class="card-box">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="product-name" class="form-control" placeholder="e.g : Masayi">
                        </div>

                        <div class=" form-group mb-3">
                            <label for="product-reference">Reference <span class="text-danger">*</span></label>
                            <input type="text" id="product-reference" class="form-control" placeholder="e.g : Silipper">
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2" id="product-category">
                                ...
                                <optgroup label="Shopping">
                                    ...
                                    <option value="chlid">Children</option>
                                </optgroup>
                            </select>
                        </div>

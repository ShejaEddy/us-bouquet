        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 style="margin-left:20px" class="modal-title" >Edit Category</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div style="margin-left:15px" class="modal-body">
                    ...
                    <form @submit.prevent="updateSubCategory()">
                        <div class="col-lg-12 marginTop">
                            ...
                            <div class="col-lg-4">
                                <input id="name" v-model="category.name" class="form-control" style="width:200%" type="text"
                        ...
                        <div class="marginTop col-lg-12">
                            ...
                            <div class=" col-lg-8">
                                <textarea id="description" v-model="category.description" class="form-control"></textarea>
                            </div>
                        </div>
                    </form>
                </div>

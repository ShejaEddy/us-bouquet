<template>
    <div class="home-component">
        <div class="row mr-auto ml-auto">
            <div class="col-md-9 order-md-1 part-2">
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img class="d-block w-100 img-fluid sld" src="/img/3.jpg" alt="Third slide">
                        </div>
                    </div>
                ...
                <div class="addons">
                    <div class="priceoff">
                        ...
                        <div class="title">
                            ...
                            <p class="shop-now">SHOP NOW <i class="fas fa-external-link-alt"></i></p>
                        </div>
                    </div>
                    <div class="deal">
                        <p>DEAL OF THE DAY</p>
        ...
        <div class="ft-container">
            <div class="feat">
                <span class="txt-ft" aria-current="page">FEATURE PRODUCTS</span>
                <router-link to="/products" class="show-ft">Show All</router-link>
            </div>
        </div>
